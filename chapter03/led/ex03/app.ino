...
void loop()
{
  ...
  delay(1000);
  digitalWrite(led1_pin, LOW);  // 3번 핀 HIGH 출력(on)
  digitalWrite(led2_pin, HIGH); // 4번 핀 LOW 출력(off)
  digitalWrite(led3_pin, LOW);  // 5번 핀 LOW 출력(off)
  digitalWrite(led4_pin, LOW);  // 6번 핀 LOW 출력(off)
  delay(1000);
  digitalWrite(led1_pin, LOW);  // 3번 핀 HIGH 출력(on)
  digitalWrite(led2_pin, LOW);  // 4번 핀 LOW 출력(off)
  digitalWrite(led3_pin, HIGH); // 5번 핀 LOW 출력(off)
  digitalWrite(led4_pin, LOW);  // 6번 핀 LOW 출력(off)
  delay(1000);
  digitalWrite(led1_pin, LOW);  // 3번 핀 HIGH 출력(on)
  digitalWrite(led2_pin, LOW);  // 4번 핀 LOW 출력(off)
  digitalWrite(led3_pin, LOW);  // 5번 핀 LOW 출력(off)
  digitalWrite(led4_pin, HIGH); // 6번 핀 LOW 출력(off)
  delay(1000);
}